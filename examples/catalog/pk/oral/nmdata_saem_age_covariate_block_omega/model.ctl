; Source: NMautoverse/NMdata
; Source URL: https://github.com/NMautoverse/NMdata
; Upstream path: inst/examples/nonmem/xgxr133.mod
; Upstream license: MIT + file LICENSE
; Adaptations: renamed from .mod to .ctl; added provenance header;
; retained illustrative $DATA, MSFO, and output FILE= paths.
$PROBLEM    031 SAEM
...
$DATA     ../../../../shared_data/nmautoverse/xgxr2covs.csv IGNORE=@ IGNORE=(FLAG.NE.0) IGNORE(DOSE.LT.30)
